...
pacstrap /mnt i3-wm i3blocks i3lock i3status numlockx xorg-server xorg-apps xorg-xinit lightdm lightdm-gtk-greeter ranger rofi dmenu kitty --noconfirm --needed
